...
- Tokens stored in 1Password ("Slack" item in your 1Password vault)
...
- Integration tests: real API calls against developer sandbox (`your-workspace.slack.com`), marked with `@pytest.mark.integration`
...
- **1Password item:** "Slack" item in your vault
